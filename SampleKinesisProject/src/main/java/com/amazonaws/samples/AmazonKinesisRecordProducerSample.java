...
public class AmazonKinesisRecordProducerSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String myStreamName = "SampleStream";
        final Integer shardCount = 1;
        ...
        while ((readLine = b.readLine()) != null) {
        	System.out.println(readLine);
             ...
             putRecordRequest.setData(ByteBuffer.wrap((readLine+"\n").getBytes()));
             System.out.println(String.format("partitionKey-%d", createTime));
