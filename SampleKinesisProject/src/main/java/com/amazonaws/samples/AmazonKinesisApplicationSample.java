...
public final class AmazonKinesisApplicationSample {
    ...
    public static final String SAMPLE_APPLICATION_STREAM_NAME = "SampleStream";

    private static final String SAMPLE_APPLICATION_NAME = "StreamingKinesisApplication";

    // Initial position in the stream when the application starts up for the first time.
    // Position can be one of LATEST (most recent data) or TRIM_HORIZON (oldest available data)
    private static final InitialPositionInStream SAMPLE_APPLICATION_INITIAL_POSITION_IN_STREAM =
            InitialPositionInStream.TRIM_HORIZON;
    public static final int MAX_RECORDS_PROCESSED = 20;
    ...
    public static void main(String[] args) throws Exception {
        ...
        kinesisClientLibConfiguration.withMaxRecords(MAX_RECORDS_PROCESSED);
