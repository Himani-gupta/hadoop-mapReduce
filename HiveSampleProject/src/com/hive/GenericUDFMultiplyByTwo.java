...
public class GenericUDFMultiplyByTwo extends GenericUDF {
	...
	public Object evaluate(DeferredObject[] args) throws HiveException {
		...
		// Access the deferred value. Hive passes the arguments as "deferred"
		// objects
		// to avoid some computations if we don't actually need some of the
		// values
